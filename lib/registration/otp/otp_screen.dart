              ...
              child: BlocConsumer<OtpCubit,OtpState>(
                ...
                builder: (context,state){
                  return Column(
                    children: [
                      Image.asset(
                        "assets/images/otp.png",height: 100,),
                      SizedBox(
                        height: 24,),
                      Text(
                        'Phone Verification',style: TextStyle(fontSize: 24),),
                      SizedBox(
                        height: 24,),
                      Text(
                      ...
                      SizedBox(
                        height: 24,),
                      TextButton(child: Text(widget.time != 0 ? "Wait for ${widget.time} seconds to resend ":'Resend'),
                          ...
                          onPressed: state is OtpVerifying ? null:(){
                            if(widget.formKey.currentState!.validate()){
                              if(widget.onlyverify){
                                ...
                                BlocProvider.of<OtpCubit>(context).verifyotp(email:widget._email,name:widget._name,password:widget._password,phone: widget._phone,otp:widget._otp);
                              }
                            }
                  },
                          child:Text('Verify') ),
