...
class OtpCubit extends Cubit<OtpState>{
  ...
  void verifyotp({required String phone,required String otp,required String email,required String password,required String name}){
    emit(OtpVerifying());
    otpRepository.verifyotp(phone, otp).
    then((response){
...
void _createAccount(email,phone,name,password){
    otpRepository.createAccount(email: email, name: name, password: password, phone: phone).
    then((response){
